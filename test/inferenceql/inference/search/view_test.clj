(ns inferenceql.inference.search.view-test
  (:require [clojure.test :refer [deftest is]]
            [inferenceql.inference.search.view :as search.view]
...
;; the cause is unknown. https://github.com/probcomp/inferenceql.inference/issues/46
